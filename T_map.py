...
wks_type = "png"
wks = Ngl.open_wks(wks_type,"T_winter")
...
T_850,lonnew = Ngl.add_cyclic(temp["winter"][0,0,2,:,:],lons[:])
bres.tiMainString      = "DJF Mean Temperature (K) at 850 hPa from 1979 to 2009"
...
plot1 = Ngl.contour_map(wks,T_850,bres)

#for 500 hPa
T_500,lonnew = Ngl.add_cyclic(temp["winter"][0,0,5,:,:],lons[:])
bres.tiMainString      = "DJF Mean Temperature (K) at 500 hPa from 1979 to 2009"
bres.cnLevelSpacingF       =  3
plot2 = Ngl.contour_map(wks,T_500,bres)

# for 100 hPa
T_100,lonnew = Ngl.add_cyclic(temp["winter"][0,0,11,:,:],lons[:])
bres.tiMainString      = "DJF Mean Temperature (K) at 100 hPa from 1979 to 2009"
bres.cnLevelSpacingF       =  2
